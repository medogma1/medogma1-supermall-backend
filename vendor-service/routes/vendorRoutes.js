...
router.get('/featured-stores', vendorController.getFeaturedStores); // جلب المتاجر المميزة (عامة)
router.get('/email/:email', vendorController.getVendorByEmail); // جلب بائع بالبريد الإلكتروني
router.get('/:id/products', vendorController.getVendorProducts); // منتجات البائع (عامة)
...
// Routes المتاجر المميزة (خاصة بالمدير فقط)
router.get('/admin/featured-stores', roleMiddleware.requireAdmin, vendorController.getFeaturedStores); // جلب المتاجر المميزة
router.post('/admin/featured-stores', roleMiddleware.requireAdmin, vendorController.addFeaturedStore); // إضافة متجر مميز
router.put('/admin/featured-stores/:id', roleMiddleware.requireAdmin, vendorController.updateFeaturedStore); // تحديث متجر مميز
router.delete('/admin/featured-stores/:id', roleMiddleware.requireAdmin, vendorController.removeFeaturedStore); // حذف متجر مميز
